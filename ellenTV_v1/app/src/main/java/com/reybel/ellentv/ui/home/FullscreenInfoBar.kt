...
fun FullscreenInfoBar(
    ...
    val infoData = remember(selectedId, channelMap, epgItemMap) {
        derivedStateOf {
            val infoItem = selectedId?.let { epgItemMap[it] }
            val infoCh = selectedId?.let { channelMap[it] }
